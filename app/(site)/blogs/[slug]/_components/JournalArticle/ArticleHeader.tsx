...
import { categoryLabel, formatPostDate } from '../../../_components/categories'
    ...
    <header style={{ paddingTop: 56, paddingBottom: 32 }}>
      <div className="gbx-container-narrow">
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24, fontSize: 13, color: 'var(--gb-ink-3)' }}>
          <Link href="/blogs" style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 24 }}>
          <span className="tag tag-accent">{categoryLabel(post.category)}</span>
        </div>
